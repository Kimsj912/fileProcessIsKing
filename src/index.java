...
public class index {
    ...
    // Setup File Name
    private static String sectionName = "04";
    private static String sectionCategory = "brute-force";

    private static File fromDir = new File(EFileDirectories.getFromFileDir());
